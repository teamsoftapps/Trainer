...
const DeleteCardModal: React.FC<Props> = ({ modalstate, onRequestClose, CardData }) => {
    const Removecard = () => {
        onRequestClose()
        axiosBaseURL
            ...
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                <View
                    ...
                    <View
                        ...
                        <Text
                            style={{ fontWeight: '400', color: 'black', textAlign: 'center', fontSize: responsiveFontSize(2) }}>
