...
{ id: 2, heading: "Booking Confirmed", desc: "Your sessio with Samantha has been confirmed for June 5 at 8:00 AM", bottom: "View Details", bottom2: "Mark as done", timeago: "3 hours ago" },
            ...
            <FlatList data={Notifications} renderItem={({ item }) => {
                return (
                    ...
                    <View style={{ backgroundColor: "#232323" }}>
                        <View style={{ width: "85%", alignSelf: "center", gap: responsiveHeight(2), paddingVertical: responsiveHeight(3) }}>
                            <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                <Text style={{ color: "white", fontSize: responsiveFontSize(2) }}>{item.heading}</Text>
                                <Text style={{ color: "#B8B8B8", fontSize: responsiveFontSize(1.5) }}>{item.timeago}</Text>
                            </View>
                            <Text numberOfLines={2} style={{ color: "#B8B8B8", width: "80%" }}>
                                {item.desc}
                            </Text>
                            <View style={{ alignItems: "center", flexDirection: "row", gap: responsiveScreenWidth(3) }}>
